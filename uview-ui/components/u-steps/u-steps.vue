		...
		>
			...
			>
				...
				<view class="u-steps__item__dot" v-if="mode == 'dot'" :style="{ 
					backgroundColor: item.color ? item.color : index <= current ? activeColor : unActiveColor 
				}"></view>
				...
				<view class="u-steps__item__line" :class="['u-steps__item__line--' + mode]" v-if="index < list.length - 1">
					<u-line :direction="direction" length="100%" :hair-line="false" :color="lineColor"></u-line>
				</view>
			</view>
		</view>
	</view>
